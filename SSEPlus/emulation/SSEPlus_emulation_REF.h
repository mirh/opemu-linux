...
/** \SSE4_1{Reference,_mm_extract_epi16} */
SSP_FORCEINLINE int ssp_extract_epi16_REF( __m128i a, const int imm )
{
    ssp_m128 A;
    A.i = a;
    return (int)A.u16[imm&0x7];
}
...
SSP_FORCEINLINE __m128d ssp_ceil_pd_REF( __m128d a )                                        
{
    ...
    A.f64[0] = ssp_ceil( A.f64[0] );
    A.f64[1] = ssp_ceil( A.f64[1] );
    return A.d;
}
...
SSP_FORCEINLINE __m128 ssp_ceil_ps_REF( __m128 a )                                          
{
    ...
    A.f32[0] = (ssp_f32)ssp_ceil( A.f32[0] );
    A.f32[1] = (ssp_f32)ssp_ceil( A.f32[1] );
    A.f32[2] = (ssp_f32)ssp_ceil( A.f32[2] );
    A.f32[3] = (ssp_f32)ssp_ceil( A.f32[3] );
    return A.f;
}
...
SSP_FORCEINLINE __m128 ssp_ceil_ss_REF( __m128 a, __m128 b)                               
{
    ...
    A.f32[0] = (ssp_f32)ssp_ceil( B.f32[0] );
    return A.f;
}
...
SSP_FORCEINLINE __m128d ssp_floor_pd_REF( __m128d a )                                       
{
    ...
    A.f64[0] = ssp_floor( A.f64[0] );
    A.f64[1] = ssp_floor( A.f64[1] );
    return A.d;
}
...
SSP_FORCEINLINE __m128 ssp_floor_ps_REF( __m128 a )                                         
{
    ...
    A.f32[0] = (float)ssp_floor( A.f32[0] );
    A.f32[1] = (float)ssp_floor( A.f32[1] );
    A.f32[2] = (float)ssp_floor( A.f32[2] );
    A.f32[3] = (float)ssp_floor( A.f32[3] );
    return A.f;
}
...
SSP_FORCEINLINE __m128 ssp_floor_ss_REF( __m128 a, __m128 b )                            
{
    ...
    A.f32[0] = (float)ssp_floor( B.f32[0] );
    return A.f;
}
